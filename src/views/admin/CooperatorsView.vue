<template>
    <div>
        {{ this.pdf }}
        <button
            style="position: absolute; right:1%; bottom:20%"
        ...
        <CompleteTestPdf
            ...
            v-if="this.pdfIsVisible"
        ></CompleteTestPdf>
        <div v-if="!this.pdfIsVisible">
                                ...
                                <v-col class="ma-0 pa-0" cols="12" md="10">
                                    ...
                                    >
                                        <template v-slot:no-data
                                            >There are no users registered with
                                            that email, press enter to select
                                            anyways.</template
                                        >
                                    </v-combobox>
                                </v-col>
...
import CompleteTestPdf from "@/components/atoms/CompleteTestPdf.vue";
