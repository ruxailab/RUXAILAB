<template>
    <v-container class="pa-0 ma-0" fluid>
        ...
        <v-dialog
            :value="flagToken && flagUser && !logined"
            width="500"
            persistent
        >
            <v-card v-if="user">
    ...
    methods: {
        ...
        async setTest() {
            if (this.user.myAnswers && this.test) {
                ...
                let alreadyAccepted = answers.find(
    ...
    computed: {
            ...
            return [
                {
                    ...
                    bottom: "#000",
                    description:
                        "Take a look at how your evaluators are doing.",
                    cardStyle:
        ...
        accessLevel() {
            ...
            if (this.user) {
                ...
                const isTestOwner =
                    this.test.testAdmin?.userDocId === this.user.id;
