    ...
    <v-form ref="basicInfoForm">
      <div class="step-header mb-6">
        <h3 class="text-h6 font-weight-bold mb-2">
          {{ $t('UserTestTaskDialog.steps.step1Title') }}
        </h3>
        <p class="text-body-2 text-grey-darken-1 mb-0">
          {{ $t('UserTestTaskDialog.steps.step1Desc') }}
        </p>
      </div>
      ...
      <v-row>
        <v-col cols="12" class="pb-0 mb-0">
          <p class="text-subtitle-2 font-weight-medium">
            {{ $t('UserTestTaskDialog.fields.taskTitle') }}
            <span class="text-error">*</span>
          </p>
          <p class="text-caption text-grey-darken-1 mb-2">
            <v-icon size="14" class="mr-1">mdi-information-outline</v-icon>
            {{ $t('UserTestTaskDialog.fields.taskTitleHint') }}
          </p>
          <v-text-field
            ...
            :placeholder="$t('UserTestTaskDialog.fields.taskTitlePlaceholder')"
        ...
        <v-col cols="12">
          ...
          <p class="text-caption text-grey-darken-1 mb-2">
            <v-icon size="14" class="mr-1">mdi-information-outline</v-icon>
            {{ $t('UserTestTaskDialog.fields.taskDescriptionHint') }}
          </p>
          <div
          ...
          >
            {{ $t('UserTestTaskDialog.validation.fieldRequired') }}
          </span>
        </v-col>

        <v-col cols="12">
          <p class="text-subtitle-2 font-weight-medium">
            {{ $t('UserTestTaskDialog.fields.taskTip') }}
          </p>
          <p class="text-caption text-grey-darken-1 mb-2">
            <v-icon size="14" class="mr-1">mdi-information-outline</v-icon>
            {{ $t('UserTestTaskDialog.fields.taskTipHint') }}
          </p>
          <v-text-field
            ...
            :placeholder="$t('UserTestTaskDialog.fields.taskTipPlaceholder')"
            @update:model-value="validateStep"
          />
        </v-col>
      </v-row>
...
const editorOptions = {
  theme: 'snow',
  placeholder: t('UserTestTaskDialog.fields.taskDescriptionPlaceholder'),
  modules: {
    toolbar: [
