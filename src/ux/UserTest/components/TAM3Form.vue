<template>
  <v-form ref="form" v-model="valid">
    ...
    <v-card variant="outlined" color="primary" class="mb-6">
      <v-card-text class="text-center">
        ...
        <p class="text-body-2 text-grey-darken-3">
          Your honest feedback helps us understand comprehensive technology
          acceptance factors. All questions are required.
        </p>
      </v-card-text>
    </v-card>
    ...
    <ConstructSection
      ...
      :questions="tam3Items.computerSelfEfficacy"
      :answers="answers.computerSelfEfficacy"
      :start-index="28"
      @update:answers="updateConstructAnswers('computerSelfEfficacy', $event)"
    />

    <ConstructSection
      title="Perception of External Control"
      icon="mdi-account-cog-outline"
      color="lime-lighten-5"
      :questions="tam3Items.perceptionOfExternalControl"
      :answers="answers.perceptionOfExternalControl"
      :start-index="38"
      @update:answers="
        updateConstructAnswers('perceptionOfExternalControl', $event)
      "
    />

    <ConstructSection
      title="Computer Anxiety"
      icon="mdi-emoticon-confused-outline"
      color="red-lighten-5"
      :questions="tam3Items.computerAnxiety"
      :answers="answers.computerAnxiety"
      :start-index="42"
      @update:answers="updateConstructAnswers('computerAnxiety', $event)"
    />

    <ConstructSection
      title="Computer Playfulness"
      icon="mdi-emoticon-happy-outline"
      color="yellow-lighten-5"
      :questions="tam3Items.computerPlayfulness"
      :answers="answers.computerPlayfulness"
      :start-index="46"
      @update:answers="updateConstructAnswers('computerPlayfulness', $event)"
    />

    <ConstructSection
      title="Perceived Enjoyment"
      icon="mdi-heart-outline"
      color="deep-purple-lighten-5"
      :questions="tam3Items.perceivedEnjoyment"
      :answers="answers.perceivedEnjoyment"
      :start-index="53"
      @update:answers="updateConstructAnswers('perceivedEnjoyment', $event)"
    />

    <ConstructSection
      title="Objective Usability"
      icon="mdi-target"
      color="brown-lighten-5"
      :questions="tam3Items.objectiveUsability"
      :answers="answers.objectiveUsability"
      :start-index="57"
      @update:answers="updateConstructAnswers('objectiveUsability', $event)"
    />
  </v-form>
</template>
...
const tam3Items = TAM3_ADDITIONAL_ITEMS
...
const totalQuestions = computed(() => {
  return (
    ...
    Object.values(tam3Items).flat().length
  )
})
