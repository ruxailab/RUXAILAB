<template>
  ...
  <v-dialog v-model="showDeclineModal" max-width="500" persistent>
    <v-card class="rounded-xl">
      <v-card-title
        class="text-h6 font-weight-bold text-error d-flex align-center"
      >
      ...
      <v-card-text class="pt-4">
        ...
        <p class="text-body-2 text-grey-darken-1 mb-3">
          If you confirm this action, the test will be terminated immediately as
          your participation requires explicit consent to proceed. Your data
...
const sanitizedConsentText = computed(() => sanitizeHtml(props.consentText))
