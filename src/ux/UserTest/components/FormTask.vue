  ...
  <v-stepper v-model="step" class="pa-sm-6" non-linear>
    <v-stepper-header>
      <v-stepper-item
        ...
        value="1"
        editable
        :title="$t('UserTestTaskDialog.steps.basicInfo')"
        @click="step = '1'"
      />
      <v-divider />
      <v-stepper-item
        ...
        value="2"
        editable
        :title="$t('UserTestTaskDialog.steps.configuration')"
        @click="step = '2'"
      />
      <v-divider />
      <v-stepper-item
        ...
        value="3"
        editable
        :title="$t('UserTestTaskDialog.steps.advanced')"
        @click="step = '3'"
      />
      <v-divider />
      <v-stepper-item
        ...
        value="4"
        editable
        :title="$t('UserTestTaskDialog.steps.preview')"
        @click="step = '4'"
      />
    </v-stepper-header>
    ...
    <v-stepper-actions
      :prev-text="$t('UserTestTaskDialog.buttons.prev')"
      :next-text="$t('UserTestTaskDialog.buttons.next')"
...
const selectItems = computed(() => [
  { label: t('UserTestTaskDialog.answerTypes.noAnswer'), value: 'no-answer' },
  { label: t('UserTestTaskDialog.answerTypes.postTest'), value: 'post-test' },
  { label: t('UserTestTaskDialog.answerTypes.textArea'), value: 'text-area' },
  { label: t('UserTestTaskDialog.answerTypes.postForm'), value: 'post-form' },
  { label: t('UserTestTaskDialog.answerTypes.nasaTlx'), value: 'nasa-tlx' },
  { label: t('UserTestTaskDialog.answerTypes.sus'), value: 'sus' },
  { label: t('UserTestTaskDialog.answerTypes.tam1'), value: 'tam-1' },
  { label: t('UserTestTaskDialog.answerTypes.tam2'), value: 'tam-2' },
  { label: t('UserTestTaskDialog.answerTypes.tam3'), value: 'tam-3' },
  { label: t('UserTestTaskDialog.answerTypes.sart'), value: 'sart' },
])
