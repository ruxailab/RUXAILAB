  ...
  >
    ...
    >
      ...
      <div class="options-table-container">
        <!-- Desktop Table View -->
        <v-card class="options-table-card desktop-table">
          <v-data-table
            :headers="headers"
          ...
          >
            ...
            <template #no-data>
              <tr>
                <td colspan="4">
                  <v-card class="text-center pa-8 my-6 empty-options-card" variant="outlined">
                    <v-icon
                    ...
                    <p class="text-body-2 text-ternary empty-state-text">
