      ...
      >
        ...
        >
          <v-tooltip location="top">
            ...
            <span>{{
              heuristics[index]?.title ||
              $t('HeuristicsTable.titles.unknownHeuristic')
            }}</span>
          </v-tooltip>
        </v-tab>
      </v-tabs>
                ...
                >
                  ...
                  >
                    <template #activator="{ props }">
                      <v-radio
                        v-bind="props"
                        :label="t(`HeuristicsWeightsTable.importance.${rad}`)"
                        :value="r"
                        color="#FCA326"
                        class="weight-radio"
                    ...
                    <span>
                      {{
                        $t(
                          'HeuristicsWeightsTable.messages.comparisonTooltip',
                          {
                            h1: tabs + 1,
                            importance: t(
                              `HeuristicsWeightsTable.importance.${rad}`,
                            ),
                            h2: f + (tabs + 1),
                          },
                        )
