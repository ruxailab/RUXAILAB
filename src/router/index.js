...
import manualAccessibilityRoutes from '@/router/modules/manualAccessibility';
import automaticAccessibilityRoutes from '@/router/modules/automaticAccessibility';
import store from '@/store'

const routes = [...Public, ...Admin, ...SuperAdmin, ...CardSorting, ...manualAccessibilityRoutes, ...automaticAccessibilityRoutes]
