                ...
                <v-row dense>
                    <v-col cols="12" sm="6">
                        <v-text-field v-model="password.newPassword" :rules="password.passwordRules"
                            :label="$t('profile.newPassword')" :type="password.showPassword ? 'text' : 'password'"
                            variant="outlined" density="compact" prepend-inner-icon="mdi-lock"
                    ...
                    <v-col cols="12" sm="6">
                        <v-text-field v-model="password.confirmPassword" :rules="password.confirmPasswordRules"
                            ...
                            :type="password.showConfirmPassword ? 'text' : 'password'" variant="outlined"
                            density="compact" prepend-inner-icon="mdi-lock-check"
