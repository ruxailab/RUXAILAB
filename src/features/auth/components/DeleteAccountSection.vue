      ...
      >
        ...
        <div v-if="deleteAccount.deleteStep === 1">
          <v-card-text>
            ...
            <div class="text-center">
              ...
              <v-text-field
                v-model="deleteAccount.deleteConfirmText"
                variant="outlined"
                density="compact"
                hide-details
          ...
          <v-card-actions class="justify-center">
            ...
            <v-btn
              ...
              class="text-capitalize"
              min-width="120"
              :loading="deleteAccount.isDeleting"
              :disabled="deleteAccount.deleteConfirmText !== 'DELETE'"
        ...
        <div v-else>
          <v-card-text>
            ...
            <v-text-field
              v-model="deleteAccount.userPassword"
          ...
          <v-card-actions class="justify-center">
            <v-btn
              ...
              :disabled="deleteAccount.isDeleting"
              min-width="120"
              @click="deleteAccount.deleteStep = 1"
            >
              {{ $t('profile.back') }}
            </v-btn>
            <v-btn
              ...
              class="text-capitalize"
              :loading="deleteAccount.isDeleting"
              :disabled="!deleteAccount.userPassword || deleteAccount.isDeleting"
              min-width="120"
              @click="handleDelete"
            >
              <v-icon start>
