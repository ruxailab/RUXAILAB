                ...
                <div v-else>
                    ...
                    <v-card-actions class="justify-center">
                        ...
                        <v-btn 
                            ...
                            class="text-capitalize" 
                            :loading="deleteAccount.isDeleting.value"
                            :disabled="!deleteAccount.userPassword.value || deleteAccount.isDeleting.value" 
                            min-width="120"
                            @click="handleDelete"
                        >
                            <v-icon start>mdi-delete</v-icon>
...
const handleProceed = async () => {
    if (deleteAccount.deleteConfirmText.value === 'DELETE' && !deleteAccount.isDeleting.value) {
