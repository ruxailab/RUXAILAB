      ...
      <div slot="content" class="ma-0 pa-0">
        <v-card flat rounded="xl" style="background: #f5f7ff">
          <v-row v-if="resultHeuristics" class="ma-0 pa-0">
              ...
              <v-list outlined rounded dense height="560px" >
                ...
                <v-list dense height="470px"  class="list-scroll">
                  <v-list-item-group v-model="questionSelect" color="#fca326">
                    ...
                    <v-list-item v-for="(item, i) in resultHeuristics[heuristicSelect]
                      .questions" :key="i" :value="i"
                    >
                      <v-list-item-content>
                        <v-list-item-title>{{ item.id }}</v-list-item-title>
                      </v-list-item-content>
            ...
            <!--Content-->
            <v-col v-if="questionSelect !== null &&
                ...
                <v-row v-else class="ma-0 pa-0">
                  ...
                  <v-col v-if="ind == 0">
                    <v-row class="list-scroll" style="height: 430px" justify="center">
                      <v-col cols="10">
                        <v-timeline v-if="resultHeuristics[heuristicSelect].questions[
                          questionSelect
                        ].result.length
                        " dense
                        >
                          <div v-for="(result, index) in resultHeuristics[
                            heuristicSelect
