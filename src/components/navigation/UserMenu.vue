...
*/
<template>
    <div v-if="user" class="d-none d-lg-flex">
        <v-menu v-model="menu" :offset="[0, 8]" min-width="300" transition="slide-y-transition"
            ...
            <template #activator="{ props }">
                <v-btn variant="text" class="pa-0 btn-fix" v-bind="props">
                    <v-avatar size="24" class="mr-1">
                        ...
                        <v-icon v-else color="white" size="24">mdi-account-circle</v-icon>
                    </v-avatar>
