              ...
              <v-text-field
                ...
                :label="
                  itemEdit.title === $t('HeuristicsTable.titles.editHeuristic')
                    ? $t('placeholders.titleHeuristic')
                    : $t('placeholders.titleQuestion')
                "
                outlined
                class="mx-3"
                :rules="itemEdit.rule"
...
<<<<<<< HEAD
            >{{ $t('HeuristicsTable.titles.cancel') }}</v-btn
          >
    ...
    <v-dialog v-model="dialogQuestion" width="800" persistent>
      <v-card v-if="newQuestion">
        <v-card-title
          ...
          primary-title
<<<<<<< HEAD
          >{{ $t('HeuristicsTable.titles.newQuestion') }}</v-card-title
=======
>>>>>>> develop
        >
          New Question
    ...
    <v-dialog v-model="dialogHeuris" width="800" persistent>
      <v-card style="overflow: hidden">
        <v-card-title
          ...
          primary-title
<<<<<<< HEAD
          >{{ $t('HeuristicsTable.titles.creatingHeuristic') }}</v-card-title
=======
>>>>>>> develop
        >
...
>>>>>>> develop
                  >
                    <strong>Add new heuristic</strong>
                  </v-list-item-title>
                </v-list-item-content>
                <!-- <v-btn
                  icon
...
<<<<<<< HEAD
                <v-clamp autoresize :max-lines="2"
                  ...
                  {{ $t('HeuristicsTable.titles.Questions') }}</v-clamp
                >
=======
                <v-clamp autoresize :max-lines="2">
