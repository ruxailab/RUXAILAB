    ...
    <section>
                ...
                <v-container>
                    <v-row align="center" class="mb-10">
                        <v-col class="text-left" cols="12" md="6">
                            <h1
                                class="display-3 font-weight-regular mb-4 white--text"
                            >
                                UX Remote LAB
                            </h1>
                            ...
                            <p
                                ...
                                align="justify"
                            >
                                Join our OpenSource project and start creating
                                your own usability LAB and share it with
                                friends. Researching has never been easier!
                            </p>
                            <v-btn
                                color="white"
                                outlined
        ...
        <v-container class="hidden-md-and-up ma-0 pa-0">
            <div style="background-color: #f4b700">
                <div style="background-color: #f4b700">
                    <h1
                        class="display-3 font-weight-regular white--text text-center"
                    >
                        UX Remote LAB
                    </h1>
                </div>
                ...
                <div style="background-color: #f4b700" class="mx-3">
                    <v-row justify="center">
                        <p class="white--text mb-4 mx-4 text-center">
                            Join our OpenSource project and start creating your
                            own usability LAB and share it with friends.
                            Researching has never been easier!
                        </p>
                        <v-btn
                            color="white"
                            outlined
