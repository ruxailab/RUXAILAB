    ...
    <v-row justify="space-around">
      ...
      <v-col cols="5">
        <v-radio-group v-model="localTask.taskType" :label="$t('titles.answerType')" :mandatory="false"
          :rules="requiredRule">
          <v-radio :label="$t('switches.noAnswer')" value="no-answer" />
          <v-radio :label="$t('switches.textArea')" value="text-area" />
          <v-radio :label="$t('switches.postTest')" value="post-test" />
          <v-radio :label="$t('switches.postForm')" value="post-form" />
          <v-radio :label="$t('switches.nasa')" value="nasa-tlx" />
          <v-radio label="System Usability Scale" value="sus" />
